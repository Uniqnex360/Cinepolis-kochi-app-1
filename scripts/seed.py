"""
Seed KOCHI1 backend with multi-city cinemas, screens, seats, movies, showtimes.
"""
...
CINEMAS: list[dict] = [
    {"name": "Cinepolis Centre Square", "screens": 2},
]
CHAIN_CITY = "Kochi"
MOVIES: list[dict] = [
    {
...
def seed(db_url: str | None = None) -> None:
    ...
    print(
        f"KOCHI1 seeded: {len(CINEMAS)} cinemas in {CHAIN_CITY}, "
